...
if __name__ == '__main__':
    ...
    for directory in dir_list:
        ...
        even_col = [i for i in range(n_col) if i%2 == 0]
        odd_col = [i for i in range(n_col) if i%2 != 0]
        ...
        df.plot(y='dx',style='b-',ax=ax)
        #df.plot(y='ddx',style='bx-',ax=ax)
        df.plot(y='dy',style='r-',ax=ax)
        #df.plot(y='ddy',style='rx-',ax=ax)
        #df.plot(y='dddy',style='r.-',ax=ax)
    plt.show()
